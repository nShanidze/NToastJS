...
document.body.appendChild(NToastLoaded);
  ...
  let id = 0;let closeTime = 100;let c = 0;
    ...
    if(position == "tr" ||  position == "TR")// TOP RIGHT
    {
      $(".NToastJs-loaded").css({
      "left":"auto" , 
      "top":"0" , 
    ...
    if(position == "tl" ||  position == "TL")// TOP LEFT
    {
      $(".NToastJs-loaded").css({
      "left":"0" , 
      "top":"0" , 
    ...
    if(position == "br" ||  position == "BR")// BOTTOM RIGHT
    {
      $(".NToastJs-loaded").css({
      "left":"auto" , 
      "top":"auto" , 
    ...
    if(position == "bl" ||  position == "BL")// BOTTOM left
    {
      $(".NToastJs-loaded").css({
      "left":"0" , 
      "top":"auto" , 
  ...
  //  $(".NToastJs-loaded").css({"left":"0" , "top":"0" , "right":"auto" , "bottom":"auto"})
    ...
    if(description.length >= 1)
    {
      ...
      if(costum_icon.length >= 2)
      {
          addicon = addicon.replace("fa fa-check",costum_icon)
      }
      if(progressbar)
      {
        progress = "<div class='NToastJs-progress' id='progress-"+id+"'></div>";
      }
      else {progress = ''}
      id++;
