 ...
 *
 */
var NToastLoaded = document.createElement("div");NToastLoaded.classList.add("NToastJs-loaded"),document.body.appendChild(NToastLoaded);
...
"tl" != position && "TL" != position || $(".NToastJs-loaded").css({
left: "0",
top: "0",
right: "auto",
bottom: "auto"
}),
"br" != position && "BR" != position || $(".NToastJs-loaded").css({
left: "auto",
top: "auto",
right: "0",
bottom: "0"
...
costum_icon.length >= 2 && (addicon = addicon.replace("fa fa-check", costum_icon)), progressbar ? progress =
"<div class='NToastJs-progress' id='progress-" + id + "'></div>" : progress = "";
id++;
